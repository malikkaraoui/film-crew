...
export const SERVICES_METADATA: Record<string, ServiceMetadata> = {
  ...
  'sketch-local': {
    ...
    description: 'Animation sketch crayon papier ultra-degradee (5fps + texte)',
  },
  'local-placeholder': {
    ...
    description: 'Fallback local minimal quand aucun provider image nest reellement disponible',
    notes: 'Ne remplace pas un vrai provider creatif - garde-fou de continuite uniquement',
  },
